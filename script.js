...
function displaySearchResults(results) {
  ...
  if (!resultsContainer) {
    // Buat container hasil pencarian jika belum ada
...
if (typeof module !== 'undefined' && module.exports) {
  ...
  // Event untuk menampilkan komentar tanpa backend
  ...
  // Tampilkan popup ketika tombol WA diklik
  waButton.addEventListener("click", (e) => {
    e.stopPropagation(); // mencegah klik dihitung sebagai klik luar
    waPopup.classList.toggle("show");
  });

  // Agar klik link WA tidak ditutup popupnya
